...
<?php $this->load->view("_partialsindex/navbar.php") ?>
						...
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="<?php echo base_url('assetsindex/images/dashboard_full_1.jpg')?>" alt="">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="<?php echo base_url('assetsindex/images/dashboard_full_2.jpg')?>" alt="">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="<?php echo base_url('assetsindex/images/dashboard_full_3.jpg')?>" alt="">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row mobile-wrap">
					<div class="col-md-5 animate-box">
						<div class="mobile-img" style="background-image: url(<?php echo base_url('assetsindex/images/mobile-2.jpg')?>);"></div>
					</div>
				...
				<div class="row mobile-wrap">
					<div class="col-md-5 col-md-push-7 animate-box">
						<div class="mobile-img" style="background-image: url(<?php echo base_url('assetsindex/images/mobile-1.jpg')?>);"></div>
					</div>
		...
		<div id="colorlib-counter" class="colorlib-counters" style="background-image: url(<?php echo base_url('assetsindex/images/cover_img_1.jpg')?>);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-4 animate-box">
						<article>
							...
							<p class="author-wrap"><a href="#" class="author-img" style="background-image: url(<?php echo base_url('assetsindex/images/person1.jpg')?>);"></a> <a href="#" class="author">by Dave Miller</a></p>
						</article>
					</div>
					<div class="col-md-4 animate-box">
						<article>
							...
							<p class="admin"><span>May 12, 2018</span></p>
							<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life</p>
							<p class="author-wrap"><a href="#" class="author-img" style="background-image: url(<?php echo base_url('assetsindex/images/person2.jpg')?>);"></a> <a href="#" class="author">by Dave Miller</a></p>
						</article>
					</div>
					<div class="col-md-4 animate-box">
						<article>
							...
							<p class="admin"><span>May 12, 2018</span></p>
							<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life</p>
							<p class="author-wrap"><a href="#" class="author-img" style="background-image: url(<?php echo base_url('assetsindex/images/person3.jpg')?>);"></a> <a href="#" class="author">by Dave Miller</a></p>
						</article>
					</div>
				</div>
			</div>
		...
		<div id="colorlib-subscribe" class="colorlib-subscribe" style="background-image: url(<?php echo base_url('assetsindex/images/cover_img_1.jpg')?>);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="row row-pb-md">
					...
					<div class="col-md-3 colorlib-widget">
						<h4>Recent Blog</h4>
						<div class="f-blog">
							<a href="blog.html" class="blog-img" style="background-image: url(<?php echo base_url('assetsindex/images/blog-1.jpg')?>);">
							</a>
							<div class="desc">
						...
						<div class="f-blog">
							<a href="blog.html" class="blog-img" style="background-image: url(<?php echo base_url('assetsindex/images/blog-2.jpg')?>);">
							</a>
							<div class="desc">
						...
						<div class="f-blog">
							<a href="blog.html" class="blog-img" style="background-image: url(<?php echo base_url('assetsindex/images/blog-3.jpg')?>);">
							</a>
							<div class="desc">
