                ...
                <div class="card-body">
                    <div class="col-md-6">
                        <form action="<?php echo site_url('pegawai/kreditupdate/') ?>" method="post">
                            <input type="hidden" class="form-control" name="idpengajuankredit" value="<?= $kredit['idpengajuankredit'] ?>" required>
                            <div class="form-group">
                                <label for="jumlah">Jumlah Kredit</label>
                                <input type="text" class="form-control" name="jumlah" value="<?= $kredit['jumlah'] ?>" required>
                                <?= form_error('jumlah', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="bulan">Jangka Waktu</label>
                                <input type="text" class="form-control" name="bulan" value="<?= $kredit['bulan'] ?>" required>
                                <?= form_error('bulan', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="bunga">Bunga (%)</label>
                                <input type="text" class="form-control" name="bunga" value="<?= $kredit['bunga'] ?>" required>
                                <?= form_error('bunga', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="tanggal">Tanggal</label>
                                <input type="date" class="form-control" name="tanggal" value="<?= $kredit['tanggal'] ?>" required>
