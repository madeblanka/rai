                    ...
                    <div class="col-md-6">
                        <form action="<?php echo site_url('pegawai/nasabahupdate') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nik" placeholder="NIK" value="<?= $nasabah['nik']; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username" placeholder="Username" value="<?= $nasabah['username']; ?>" readonly>
                                <?= form_error('username', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="text" class="form-control" name="password" placeholder="password" value="<?= $nasabah['password']; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lamakerja_tahun" aria-describedby="emailHelp" placeholder="Lama Bekerja (Tahun)" value="<?= $nasabah['lamakerja_tahun']; ?>" readonly>
                                <?= form_error('lamakerja_tahun', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Lama Bekerja (bulan)</label>
                                <input type="text" class="form-control" name="lamakerja_bulan" aria-describedby="emailHelp" placeholder="Lama Bekerja (bulan)" value="<?= $nasabah['lamakerja_bulan']; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="alamat" aria-describedby="emailHelp" placeholder="Alamat" value="<?= $nasabah['alamat']; ?>" readonly>
                                ...
                                <div class="container" style="padding-left: 0; padding-right:0;">
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <input type="date" class="form-control" name="tgl_lahir" aria-describedby="emailHelp" placeholder="Tanggal Lahir" value="<?= $nasabah['tgl_lahir']; ?>" readonly>
